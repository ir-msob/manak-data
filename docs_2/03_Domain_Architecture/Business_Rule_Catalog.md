...
| نام سند | نوع ارتباط |
| :--- | :--- |
| `Domain_Landscape` | مرجع دامنه‌هایی که قوانین در آن‌ها اعمال می‌شوند |
...
| `Architecture_Overview` | مرجع Componentها که قوانین بر روی آن‌ها پیاده‌سازی می‌شوند |
...
| `Governance_and_Compliance_Domain.md` | مرجع رفتار Fail-Closed PDP که قانون BR‑۱۲۲ به آن ارجاع می‌دهد |
