...
> تفصیل بیشتر این سه زیرمجموعه (۹ سرویس عملیاتی) در سند `Architecture_Overview` (بخش ۶) آمده است.
...
| `Architecture_Overview` | نمای کلی معماری که این سند جزئیات کامپوننت‌های آن را تشریح می‌کند |
| `Vision_and_Strategy` | چشم‌انداز و اصول راهبردی که مرزهای مسئولیت بر اساس آن‌ها تعریف شده است |
| `High_Level_PRD` | نیازمندی‌های عملکردی که وظایف هر Component بر اساس آن‌ها مشخص شده است |
